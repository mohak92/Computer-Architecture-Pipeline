...
public class InstructionManager {
	...
	/*
	 * This instructor creates appropriate subclass instances of the abstract class Instruction
	 * It then pushes the Instruction object onto the instructions ArrayList
	 */
